...
### Jobizo — AI-Powered Job Recommendation Platform

An AI-powered platform that analyzes resumes, converts candidate profiles into embeddings, and matches them with relevant job opportunities using **semantic similarity search**.

Built with technologies including **LLMs, embeddings, Pinecone VectorDB, Python, and scheduled job scraping pipelines**.
